...
/**
 * 定义接口:[访问限制修饰符] interface InterfaceName
 * 实现接口:class ClassName implements InterfaceName1[, InterfaceName2]
 * <p>
 * 1.接口可用的访问限制修饰符有两种:public / (default)
 * 2.接口可以包含属性,但属性默认是 [public] [static] [final](可省略,不可修改)
 * 即:接口只能有静态常量
 * 3.接口可以包含方法,但方法默认是 [public](可省略,不可修改) [abstract](可省略)
